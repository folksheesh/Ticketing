...
export function Footer() {
  ...
  return (
    <footer role="contentinfo">
      ...
      <div style={{ background: 'var(--color-denso-blue)', color: 'var(--color-denso-white)' }}>
        {/* Red accent bar */}
        <div
          style={{
            height: '3px',
            background: 'linear-gradient(90deg, var(--color-denso-red), var(--color-denso-red-light), var(--color-denso-red))',
          }}
        />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-12 md:py-16 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
            ...
            <div className="space-y-4">
              <h3
                ...
                style={{ color: 'var(--color-denso-red-light)' }}
              >
                Detail Acara
              </h3>
              <ul className="space-y-3 font-sans text-sm" style={{ color: 'rgba(255,255,255,0.65)' }}>
                <li className="flex items-start gap-2.5">
                  <Calendar className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: 'var(--color-denso-red-light)' }} />
                ...
                <li className="flex items-start gap-2.5">
                  <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: 'var(--color-denso-red-light)' }} />
                  <span>
                ...
                <li className="flex items-start gap-2.5">
                  <Mail className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: 'var(--color-denso-red-light)' }} />
                  <a
          ...
          <div
            ...
            style={{ borderTop: '1px solid rgba(255,255,255,0.15)', color: 'rgba(255,255,255,0.4)' }}
          >
            <p>© {currentYear} {EVENT_CONFIG.company}. Hak cipta dilindungi.</p>
            <p className="flex items-center gap-1.5">
              Dibuat dengan{' '}
              <Heart className="w-3 h-3" style={{ color: 'var(--color-denso-red-light)', fill: 'var(--color-denso-red-light)' }} />{' '}
              oleh Tim IT Denso
            </p>
          </div>
        </div>
