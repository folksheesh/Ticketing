export const EVENT_CONFIG = {
  ...
  date: new Date('2026-09-13T08:00:00+07:00'),
  venue: {
    name: 'Bumi Perkemahan Pramuka Cibubur',
    address: 'Bumi Perkemahan Pramuka Cibubur',
    city: 'Cibubur',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Bumi+Perkemahan+Pramuka+Cibubur',
  },
